...
import IngredienteSelecionavel from './IngredienteSelecionavel.vue';
    ...
    export default {
    props: {
        //define o tipo Objeto para a propriedade categoria e que a propriedade deve ser obrigatoriamente passada para este componente
        categoria: { type: Object as PropType<ICategoria>, required: true }
        //PropType é uma tipagem utilitária
    },
...
<template>
    <article class="categoria">
        <header class="categoria__cabecalho">
            <!-- v-bind no src não funciona direito. Usa o template string `` e o /. Nesse caso a barra referência a pasta public que está na raiz do projeto -->
